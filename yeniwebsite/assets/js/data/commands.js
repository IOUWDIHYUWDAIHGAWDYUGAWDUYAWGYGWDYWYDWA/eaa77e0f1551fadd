...
export const COMMANDS = [
  ...
  { name: 'panel', category: 'arac',
    desc: { en: 'Shows the link to the VYBot web management panel.', tr: 'VYBot web yönetim panelinin bağlantısını verir.' },
    usage: '/panel', permission: null },
  { name: 'panel-bagla', category: 'arac',
    desc: { en: 'Links the web panel to this server (webhook bridge).', tr: 'Web panelini bu sunucuya bağlar (webhook köprüsü).' },
    usage: '/panel-bagla', permission: PERM.manageGuild },
